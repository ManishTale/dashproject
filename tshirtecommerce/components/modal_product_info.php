					...
					<div class="product-detail">
						...
						<div class="row">
							...
							<div class="col-xs-6 col-md-6">
								...
								<div><?php echo lang('designer_product_id'); ?>: <strong class="product-detail-id"><?php echo $product->id; ?></strong></div>
								<div><?php echo lang('designer_product_sku'); ?>: <strong class="product-detail-sku"><?php echo $product->sku; ?></strong></div>
