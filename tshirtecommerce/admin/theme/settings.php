...
<ul class="nav nav-tabs">
  <li class="active"><a href="#shop" data-toggle="tab"><?php lang('setting_tab_config'); ?></a></li>
  <li><a href="#design-store" data-toggle="tab">Design Library</a></li>
...
<div class="tab-content">
	...
	<!-- start price -->
	<div style=" min-height: 350px;" class="tab-pane" id="price" style="display: none;">
		<div class="row">
			<div class="col-md-12">
	...
	<div class="tab-pane active" id="shop">
		<div class="row">
			...
			<div class="pull-left col-md-6">
				<?php include_once('settings/upload.php'); ?>
			...
			<div class="pull-right col-md-6">
				<?php include_once('settings/layout.php'); ?>
			</div>
		</div>
	</div>
	<!-- end Config -->
