...
class Settings extends Controllers
{
	public function index()
	{
		...
		$data['title'] = lang('breadcrumb_settings', true);
	...
	public function editLang($admin = 'admin')
	{
		...
		{
			$dg->redirect(site_url('index.php/settings'));
		}
	}
	...
	public function colors()
	{
		...
		$data['title'] = lang('breadcrumb_colors', true);
	...
	public function editColor($id = '')
	{
		...
		$data['title'] = lang('breadcrumb_edit_color', true);
	...
	public function fonts()
	{
		...
		$data['title'] = lang('breadcrumb_fonts', true);
	...
	public function Languages($tyle = '')
	{
		...
		$data['title'] = lang('breadcrumb_languages', true);
...
'.$lang_plus;
		...
		$data['title'] = lang('breadcrumb_edit_language', true);
