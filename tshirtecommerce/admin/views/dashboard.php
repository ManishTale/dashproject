			...
			<div class="row">
				...
				<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
					<a class="control-panel-icon" href="<?php echo site_url('index.php/clipart'); ?>">
						<i class="clip-home-3"></i><span><?php lang('dashboard_arts_vendor')?></span>
					</a>
				</div>
				<?php } else { ?>
				<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
				...
				<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
					<?php  if($id !== 1) {?>
					<a class="control-panel-icon" href="<?php echo site_url('index.php/vendor'); ?>">
						<i class="fa fa-picture-o fa-4x"></i><span><?php lang('dashboard_vendor_arts')?></span>
					</a>
					<?php }
					?>
				</div>
