...
<div id="options-add_item_team" class="dg-options">
	<div class="dg-options-toolbar">
		<ul class="btn-group-custom">
			<li data-type="name-number" id="mobile-add-name-number">
				<i class="glyph-icon flaticon-football"></i> <small class="clearfix"><?php echo lang('designer_clipart_edit_add_name'); ?></small>
			</li>
			<li data-type="teams">
				<i class="glyph-icon flaticon-menu-1"></i> <small class="clearfix"><?php echo lang('designer_teams'); ?></small>
			</li>
			<li data-type="add-list">
				<i class="glyph-icon flaticon-user"></i> <small class="clearfix"><?php echo lang('designer_team_add_team'); ?></small>
			</li>						
		</ul>
	</div>
