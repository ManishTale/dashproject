		...
		<div class="align-center" id="right-options">
			<div class="dg-box">
				...
				<div class="product-prices">
					...
					<button <?php echo cssShow($settings, 'show_add_to_cart', 1); ?> type="button" class="btn btn-warning btn-addcart" onclick="design.ajax.addJs(this)"><i class="icon fa fa-shopping-basket"></i><?php echo lang('designer_right_buy_now'); ?></button>								
				</div>
			</div>
		</div>
	</div>
