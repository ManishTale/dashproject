...
?>
<div id='price-type-<?php echo $add_p_name; ?>-tab' class='price-type-tab <?php if ($price_type != $add_p_name) echo 'hidden' ?>'>
	<p>Setup price of one color / size</p>
		...
		<div role="tabpanel" class="tab-pane active" id="<?php echo $add_p_name; ?>-view-front">
			...
			<div class="table-responsive">
				<table class='table table-bordered'>
					<thead>
						<th class='th-first center'>Products</th>
						<?php for($i=0; $i < 7; $i++) : ?>
