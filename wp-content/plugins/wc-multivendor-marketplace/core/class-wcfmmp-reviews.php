  ...
  /**
	...
	public function show_star_rating( $store_rating = 0, $vendor_id = 0 ) {
		...
		if ( apply_filters( 'wcfm_is_pref_vendor_reviews', true ) ) { ?>
			<div class="star-rating wcfmmp-store-rating" title="<?php if( $store_rating ) { echo sprintf( __( 'Rated %s out of 5', 'wc-multivendor-marketplace' ), $store_rating ); } else { _e( 'No reviews yet!', 'wc-multivendor-marketplace' ); } ?>">
