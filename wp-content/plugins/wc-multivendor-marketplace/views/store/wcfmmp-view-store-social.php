...
<ul>
	...
	<?php if( isset( $store_info['social']['fb'] ) && !empty( $store_info['social']['fb'] ) ) { ?>
		<li><a href="<?php echo $store_info['social']['fb']; ?>" target="_blank"><i class="fab fa-facebook-f" aria-hidden="true"></i></a></li>
	<?php } ?>
	<?php if( isset( $store_info['social']['twitter'] ) && !empty( $store_info['social']['twitter'] ) ) { ?>
		<li><a href="<?php echo $store_info['social']['twitter']; ?>" target="_blank"><i class="fab fa-twitter" aria-hidden="true" target="_blank"></i></a></li>
	<?php } ?>
	<?php if( isset( $store_info['social']['linkedin'] ) && !empty( $store_info['social']['linkedin'] ) ) { ?>
		<li><a href="<?php echo $store_info['social']['linkedin']; ?>" target="_blank"><i class="fab fa-linkedin-in" aria-hidden="true" target="_blank"></i></a></li>
	<?php } ?>
	<?php if( isset( $store_info['social']['instagram'] ) && !empty( $store_info['social']['instagram'] ) ) { ?>
		<li><a href="<?php echo $store_info['social']['instagram']; ?>" target="_blank"><i class="fab fa-instagram" aria-hidden="true" target="_blank"></i></a></li>
	<?php } ?>
	<?php if( isset( $store_info['social']['youtube'] ) && !empty( $store_info['social']['youtube'] ) ) { ?>
		<li><a href="<?php echo $store_info['social']['youtube']; ?>" target="_blank"><i class="fab fa-youtube" aria-hidden="true" target="_blank"></i></a></li>
	<?php } ?>
