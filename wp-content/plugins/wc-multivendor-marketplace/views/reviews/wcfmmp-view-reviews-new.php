					...
					<div class="rating_area">
						<?php foreach( $wcfm_review_categories as $wcfm_review_cat_key => $wcfm_review_category ) { ?>
							<div class="rating_box rating-stars">
								<ul class='stars'>
									<li class='star' title="<?php _e('Poor', 'wc-multivendor-marketplace' ); ?>" data-value='1'>
										<i class='fa fa-star fa-fw'></i>
									</li>
									<li class='star' title="<?php _e('Fair', 'wc-multivendor-marketplace' ); ?>" data-value='2'>
										<i class='fa fa-star fa-fw'></i>
									</li>
									<li class='star' title="<?php _e('Good', 'wc-multivendor-marketplace' ); ?>" data-value='3'>
										<i class='fa fa-star fa-fw'></i>
									</li>
									<li class='star' title="<?php _e('Excellent', 'wc-multivendor-marketplace' ); ?>" data-value='4'>
										<i class='fa fa-star fa-fw'></i>
									</li>
									<li class='star' title="<?php _e('WOW!!!', 'wc-multivendor-marketplace' ); ?>" data-value='5'>
										<i class='fa fa-star fa-fw'></i>
									</li>
								</ul>
								<span><span class="rating_text">0</span>.0 <?php _e( $wcfm_review_category['category'], 'wc-multivendor-marketplace' ); ?></span>
								<input type="hidden" class="rating_value" name="wcfm_store_review_category[<?php echo $wcfm_review_cat_key; ?>]" value="0" />
							</div>
						<?php } ?>
					</div>
