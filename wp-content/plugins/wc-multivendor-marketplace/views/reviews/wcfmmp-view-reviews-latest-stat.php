...
<div class="famous_reviewers">
	...
	<div class="lft m10 reviews_count">
	  <?php if( $author_name ) { ?><a onClick="return false;" href="#"><?php echo $author_name; ?></a> <?php } ?>
	  <?php if( $total_review_count > 1 ) { ?> <?php _e('and', 'wc-multivendor-marketplace' ); ?> <a onClick="return false;" href="#"><?php echo ($total_review_count-1); ?> <?php _e('others', 'wc-multivendor-marketplace' ); ?></a>
    <?php } elseif( !$total_review_count ) { ?><?php _e('No user', 'wc-multivendor-marketplace' ); ?></a><?php } ?> 
    <?php _e( 'have reviewed this store', 'wc-multivendor-marketplace' ); ?>
  </div>
	<div class="spacer"></div>    
</div>