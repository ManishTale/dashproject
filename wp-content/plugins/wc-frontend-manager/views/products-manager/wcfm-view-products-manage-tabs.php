...
?>
			<?php if( apply_filters( 'wcfm_is_allow_inventory', true ) && apply_filters( 'wcfm_is_allow_pm_inventory', true ) ) { ?>
				...
				<?php if( apply_filters( 'wcfmu_is_allow_downloadable', true ) && apply_filters( 'wcfmu_is_allow_pm_downloadable', true ) ) { ?>
					<!-- collapsible 2 -->
					<div class="page_collapsible products_manage_downloadable simple downlodable non-variable-subscription non-redq_rental non-appointment" id="wcfm_products_manage_form_downloadable_head"><label class="wcfmfa fa-cloud-download"></label><?php _e('Downloadable', 'wc-frontend-manager'); ?><span></span></div>
