...
<div class="page_collapsible products_manage_costs booking" id="wcfm_products_manage_form_costs_head"><label class="wcfmfa fa-currency"><?php echo get_woocommerce_currency_symbol() ; ?></label><?php _e('Costs', 'woocommerce-bookings'); ?><span></span></div>
<div class="wcfm-container booking">
