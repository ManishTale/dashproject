	...
	public function processing() {
		...
		if(!empty($wcfm_enquirys_array)) {
			...
			foreach($wcfm_enquirys_array as $wcfm_enquirys_single) {
				...
				// Action
				$actions = '<a class="wcfm-action-icon" href="' . get_wcfm_enquiry_manage_url($wcfm_enquirys_single->ID) . '"><span class="wcfmfa fa-reply text_tip" data-tip="' . esc_attr__( 'Reply', 'wc-frontend-manager' ) . '"></span></a>';
