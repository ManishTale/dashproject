...
if( ! class_exists( 'YITH_WCWL_UI' ) ) {
    ...
    class YITH_WCWL_UI {
        ...
        public static function add_to_wishlist_button( $url, $product_type, $exists ) {
           ...
           // $html .= '<div class="wishlistmesage yith-wcwl-wishlistaddedbrowse hide" style="display:none;"><span class="feedback">' . __( 'Product added!','yith-woocommerce-wishlist' ) . '</span> <a href="' . esc_url( $url ) . '">' . apply_filters( 'yith-wcwl-browse-wishlist-label', __( 'Browse Wishlist', 'yith-woocommerce-wishlist' ) ) . '</a></div>';
           // $html .= '<div class=" wishlistmesage yith-wcwl-wishlistexistsbrowse ' . ( $exists ? 'hide' : 'hide' ) . '" style="display:' . ( $exists ? 'block' : 'none' ) . '"><span class="feedback">' . __( 'The product is already in the wishlist!', 'yith-woocommerce-wishlist' ) . '</span> <a href="' . esc_url( $url ) . '">' . apply_filters( 'yith-wcwl-browse-wishlist-label', __( 'Browse Wishlist', 'yith-woocommerce-wishlist' ) ) . '</a></div>';
