...
var payment = {
	...
	load: function(e){
		...
		jQuery('.arts-store-payment').html('<a href="javascript:void(0);" onclick="payment.cancel()"></a><iframe id="store-art-payment" scrolling="no" frameborder="0" noresize="noresize" width="100%" height="600px" src="https://9file.net/api/index/'+id+'"></iframe>');
		if(jQuery('#arts-store-mask').length == 0)
		{
