		...
		if($available_fields){
			...
			foreach($available_fields as $available_field){
				...
				$html = '<div class="form-field _product_link_field" style="float: left; margin: 10px 10px 0px;">'					
					...
					.		'<ul class="dropdown-menu">'
					.			'<li><a href="javascript:void(0)" key="123" onclick="app.admin.product(this, 1)">Use design of <strong>Admin</strong> saved</a></li>'
					.			'<li><a href="javascript:void(0)" key="123" onclick="app.admin.product(this, 2)">Use design of <strong>Clients</strong> saved</a></li>'
					.			'<li role="separator" class="divider"></li>'
					...
					. '</div><p style="clear: both;">Note: If you want hidden option design of product. Please click button "Clear" to remove all data design.</p><hr />';
