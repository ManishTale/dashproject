	...
	public function get_default_address_fields() {
		...
		$fields = array(
			'first_name' => array(
				...
				'required'     => true,
				'class'        => array( 'form-row-first form-control' ),
			...
			'country'    => array(
				...
				'required'     => true,
				'class'        => array( 'form-row-wide  form-control', 'address-field', 'update_totals_on_change' ),
			...
			'address_1'  => array(
				...
				'required'     => true,
				'class'        => array( 'form-row-wide  form-control', 'address-field' ),
