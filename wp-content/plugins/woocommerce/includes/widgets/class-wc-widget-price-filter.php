...
class WC_Widget_Price_Filter extends WC_Widget {
	...
	public function widget( $args, $instance ) {
		...
		echo '<style>.ui-slider-range.ui-widget-header{background-color:green !important;}</style><form method="get" action="' . esc_url( $form_action ) . '">
			<div class="price_slider_wrapper">
				...
				<div class="price_slider_amount">
					...
					<button type="submit" class="btn btn-primary pull-left">' . esc_html__( 'Filter', 'woocommerce' ) . '</button>
