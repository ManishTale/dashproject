...
if ( ! function_exists( 'woocommerce_template_loop_product_title' ) ) {
	...
	if (is_product_category('Create'))
	 {
	echo '<a href="'.get_home_url().'/design-your-own/?product_id='.$product->id.'">'; echo '<h4 class="woocommerce-loop-product__title">' . get_the_title() . '</h4>';?></a>
	<?php }
	 else
	{?>
		<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php	echo '<h4 class="woocommerce-loop-product__title">' . get_the_title() . '</h4>';?></a>
<?php	}
}
}
...
if ( ! function_exists( 'woocommerce_template_loop_product_link_open' ) ) {
	...
	function woocommerce_template_loop_product_link_open() {
		...
		if (is_product_category('Create'))
		{
			echo '<a href="'.get_home_url().'/design-your-own/?product_id='.$product->id.'" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">';
...
<section class="emptycartpage">    
	<div class="container">  <div class="emptycartdiv"><img src="<?php echo get_template_directory_uri(); ?>/img/empty-cart.png"> <?php echo '<h3>' . wp_kses_post( apply_filters( 'wc_empty_cart_message', __( 'Your cart is currently empty.', 'woocommerce' ) ) ) . '</h3>';
}
...
function woocommerce_output_all_notices() {
	echo '<div class="container woocommerce-notices-wrapper">';
	wc_print_notices();
	echo '</div>';
}
