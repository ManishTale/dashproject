...
(function($, window, document, undefined) {
    ...
    $.fn.imageuploadify = function(opts) {
        ...
        this.each(function() {
            ...
            let totalFiles = [];
            let counter = 0;
            let dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><i class=""><img src="img/productdetail/uploadimage.png" /></i><span class='imageuploadify-message'>Upload or drag your image here</span><span class='imageuploadify-message2'>PNG, JPG, GIF, SVG, EPS, AI, CDR</span><button type="button"class="btn btn-primary btn-sm">Upload</button></div></div>`);
            ...
            const readingFile = (id, file) => {
                ...
                let container = $(`<div class='imageuploadify-container'><button type='button'class='closepopup'><img src="img/closesign.png" /></button><div class='imageuploadify-details'><span>${file.name}</span><span>${file.type}</span><span>${file.size}</span></div></div>`);
